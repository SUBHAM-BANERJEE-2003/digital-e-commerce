...
const Footer = () => {
  return (
    <div className='bottom-0 z-10 mt-52 mb-0 border-t-slate-300 border p-3'>
  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p className="mt-4 max-w-xs text-gray-500">
          A platform designed designed to meet your learning needs with world class courses, hands-on projects and certificates.
        </p>
    ...
    <p className="text-xs text-gray-500">&copy; 2022. NextGen Courses. All rights reserved.</p>
  </div>
</footer>
</div>
  )
